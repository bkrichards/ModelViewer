...
glmReadMTL(GLMmodel* model, char* name, mycallback *call)
{
    ...
    for (i = 0; i < nummaterials; i++) {
        ...
        model->materials[i].shininess_raw = 0;
        model->materials[i].diffuse[0] = 0;
        model->materials[i].diffuse[1] = 0;
        model->materials[i].diffuse[2] = 0;
        model->materials[i].diffuse[3] = 1;
        model->materials[i].ambient[0] = 0;
        model->materials[i].ambient[1] = 0;
        model->materials[i].ambient[2] = 0;
    ...
    while(fscanf(file, "%s", buf) != EOF) {
        ...
        case 'N':
            ...
            model->materials[nummaterials].shininess_raw = model->materials[nummaterials].shininess;
